...
// Source: go.abhg.dev/gs/internal/forge (interfaces: Forge,RepositoryID,Repository,ReviewThreadLister,ChangeChecksLister,ViewerIdentifier)
//
// Generated by this command:
//
//	mockgen -destination=forgetest/mocks.go -package forgetest -typed . Forge,RepositoryID,Repository,ReviewThreadLister,ChangeChecksLister,ViewerIdentifier
//
...
// MockReviewThreadLister is a mock of ReviewThreadLister interface.
type MockReviewThreadLister struct {
	ctrl     *gomock.Controller
	recorder *MockReviewThreadListerMockRecorder
	isgomock struct{}
}

// MockReviewThreadListerMockRecorder is the mock recorder for MockReviewThreadLister.
type MockReviewThreadListerMockRecorder struct {
	mock *MockReviewThreadLister
}

// NewMockReviewThreadLister creates a new mock instance.
func NewMockReviewThreadLister(ctrl *gomock.Controller) *MockReviewThreadLister {
	mock := &MockReviewThreadLister{ctrl: ctrl}
	mock.recorder = &MockReviewThreadListerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockReviewThreadLister) EXPECT() *MockReviewThreadListerMockRecorder {
	return m.recorder
}

// ListReviewThreads mocks base method.
func (m *MockReviewThreadLister) ListReviewThreads(ctx context.Context, id forge.ChangeID, opts *forge.ListReviewThreadsOptions) iter.Seq2[*forge.ReviewThreadItem, error] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListReviewThreads", ctx, id, opts)
	ret0, _ := ret[0].(iter.Seq2[*forge.ReviewThreadItem, error])
	return ret0
}

// ListReviewThreads indicates an expected call of ListReviewThreads.
func (mr *MockReviewThreadListerMockRecorder) ListReviewThreads(ctx, id, opts any) *MockReviewThreadListerListReviewThreadsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListReviewThreads", reflect.TypeOf((*MockReviewThreadLister)(nil).ListReviewThreads), ctx, id, opts)
	return &MockReviewThreadListerListReviewThreadsCall{Call: call}
}

// MockReviewThreadListerListReviewThreadsCall wrap *gomock.Call
type MockReviewThreadListerListReviewThreadsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockReviewThreadListerListReviewThreadsCall) Return(arg0 iter.Seq2[*forge.ReviewThreadItem, error]) *MockReviewThreadListerListReviewThreadsCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockReviewThreadListerListReviewThreadsCall) Do(f func(context.Context, forge.ChangeID, *forge.ListReviewThreadsOptions) iter.Seq2[*forge.ReviewThreadItem, error]) *MockReviewThreadListerListReviewThreadsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockReviewThreadListerListReviewThreadsCall) DoAndReturn(f func(context.Context, forge.ChangeID, *forge.ListReviewThreadsOptions) iter.Seq2[*forge.ReviewThreadItem, error]) *MockReviewThreadListerListReviewThreadsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// PostReviewThreadReply mocks base method.
func (m *MockReviewThreadLister) PostReviewThreadReply(ctx context.Context, threadID forge.ReviewThreadID, body string) (forge.ChangeCommentID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PostReviewThreadReply", ctx, threadID, body)
	ret0, _ := ret[0].(forge.ChangeCommentID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// PostReviewThreadReply indicates an expected call of PostReviewThreadReply.
func (mr *MockReviewThreadListerMockRecorder) PostReviewThreadReply(ctx, threadID, body any) *MockReviewThreadListerPostReviewThreadReplyCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PostReviewThreadReply", reflect.TypeOf((*MockReviewThreadLister)(nil).PostReviewThreadReply), ctx, threadID, body)
	return &MockReviewThreadListerPostReviewThreadReplyCall{Call: call}
}

// MockReviewThreadListerPostReviewThreadReplyCall wrap *gomock.Call
type MockReviewThreadListerPostReviewThreadReplyCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockReviewThreadListerPostReviewThreadReplyCall) Return(arg0 forge.ChangeCommentID, arg1 error) *MockReviewThreadListerPostReviewThreadReplyCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockReviewThreadListerPostReviewThreadReplyCall) Do(f func(context.Context, forge.ReviewThreadID, string) (forge.ChangeCommentID, error)) *MockReviewThreadListerPostReviewThreadReplyCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockReviewThreadListerPostReviewThreadReplyCall) DoAndReturn(f func(context.Context, forge.ReviewThreadID, string) (forge.ChangeCommentID, error)) *MockReviewThreadListerPostReviewThreadReplyCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// MockChangeChecksLister is a mock of ChangeChecksLister interface.
type MockChangeChecksLister struct {
	ctrl     *gomock.Controller
	recorder *MockChangeChecksListerMockRecorder
	isgomock struct{}
}

// MockChangeChecksListerMockRecorder is the mock recorder for MockChangeChecksLister.
type MockChangeChecksListerMockRecorder struct {
	mock *MockChangeChecksLister
}

// NewMockChangeChecksLister creates a new mock instance.
func NewMockChangeChecksLister(ctrl *gomock.Controller) *MockChangeChecksLister {
	mock := &MockChangeChecksLister{ctrl: ctrl}
	mock.recorder = &MockChangeChecksListerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockChangeChecksLister) EXPECT() *MockChangeChecksListerMockRecorder {
	return m.recorder
}

// GetCheckLog mocks base method.
func (m *MockChangeChecksLister) GetCheckLog(ctx context.Context, id forge.CheckRunID) (io.ReadCloser, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCheckLog", ctx, id)
	ret0, _ := ret[0].(io.ReadCloser)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetCheckLog indicates an expected call of GetCheckLog.
func (mr *MockChangeChecksListerMockRecorder) GetCheckLog(ctx, id any) *MockChangeChecksListerGetCheckLogCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCheckLog", reflect.TypeOf((*MockChangeChecksLister)(nil).GetCheckLog), ctx, id)
	return &MockChangeChecksListerGetCheckLogCall{Call: call}
}

// MockChangeChecksListerGetCheckLogCall wrap *gomock.Call
type MockChangeChecksListerGetCheckLogCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockChangeChecksListerGetCheckLogCall) Return(arg0 io.ReadCloser, arg1 error) *MockChangeChecksListerGetCheckLogCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockChangeChecksListerGetCheckLogCall) Do(f func(context.Context, forge.CheckRunID) (io.ReadCloser, error)) *MockChangeChecksListerGetCheckLogCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockChangeChecksListerGetCheckLogCall) DoAndReturn(f func(context.Context, forge.CheckRunID) (io.ReadCloser, error)) *MockChangeChecksListerGetCheckLogCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// ListChangeChecks mocks base method.
func (m *MockChangeChecksLister) ListChangeChecks(ctx context.Context, id forge.ChangeID, opts *forge.ListChangeChecksOptions) iter.Seq2[*forge.ChangeCheckItem, error] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListChangeChecks", ctx, id, opts)
	ret0, _ := ret[0].(iter.Seq2[*forge.ChangeCheckItem, error])
	return ret0
}

// ListChangeChecks indicates an expected call of ListChangeChecks.
func (mr *MockChangeChecksListerMockRecorder) ListChangeChecks(ctx, id, opts any) *MockChangeChecksListerListChangeChecksCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListChangeChecks", reflect.TypeOf((*MockChangeChecksLister)(nil).ListChangeChecks), ctx, id, opts)
	return &MockChangeChecksListerListChangeChecksCall{Call: call}
}

// MockChangeChecksListerListChangeChecksCall wrap *gomock.Call
type MockChangeChecksListerListChangeChecksCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockChangeChecksListerListChangeChecksCall) Return(arg0 iter.Seq2[*forge.ChangeCheckItem, error]) *MockChangeChecksListerListChangeChecksCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockChangeChecksListerListChangeChecksCall) Do(f func(context.Context, forge.ChangeID, *forge.ListChangeChecksOptions) iter.Seq2[*forge.ChangeCheckItem, error]) *MockChangeChecksListerListChangeChecksCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockChangeChecksListerListChangeChecksCall) DoAndReturn(f func(context.Context, forge.ChangeID, *forge.ListChangeChecksOptions) iter.Seq2[*forge.ChangeCheckItem, error]) *MockChangeChecksListerListChangeChecksCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// MockViewerIdentifier is a mock of ViewerIdentifier interface.
type MockViewerIdentifier struct {
	ctrl     *gomock.Controller
	recorder *MockViewerIdentifierMockRecorder
	isgomock struct{}
}

// MockViewerIdentifierMockRecorder is the mock recorder for MockViewerIdentifier.
type MockViewerIdentifierMockRecorder struct {
	mock *MockViewerIdentifier
}

// NewMockViewerIdentifier creates a new mock instance.
func NewMockViewerIdentifier(ctrl *gomock.Controller) *MockViewerIdentifier {
	mock := &MockViewerIdentifier{ctrl: ctrl}
	mock.recorder = &MockViewerIdentifierMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockViewerIdentifier) EXPECT() *MockViewerIdentifierMockRecorder {
	return m.recorder
}

// ViewerLogin mocks base method.
func (m *MockViewerIdentifier) ViewerLogin(ctx context.Context) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ViewerLogin", ctx)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ViewerLogin indicates an expected call of ViewerLogin.
func (mr *MockViewerIdentifierMockRecorder) ViewerLogin(ctx any) *MockViewerIdentifierViewerLoginCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ViewerLogin", reflect.TypeOf((*MockViewerIdentifier)(nil).ViewerLogin), ctx)
	return &MockViewerIdentifierViewerLoginCall{Call: call}
}

// MockViewerIdentifierViewerLoginCall wrap *gomock.Call
type MockViewerIdentifierViewerLoginCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockViewerIdentifierViewerLoginCall) Return(arg0 string, arg1 error) *MockViewerIdentifierViewerLoginCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockViewerIdentifierViewerLoginCall) Do(f func(context.Context) (string, error)) *MockViewerIdentifierViewerLoginCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockViewerIdentifierViewerLoginCall) DoAndReturn(f func(context.Context) (string, error)) *MockViewerIdentifierViewerLoginCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
